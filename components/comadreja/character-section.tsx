    ...
    >
      ...
      <div className="absolute inset-0 opacity-[0.3]">
        <div className="w-full h-full relative">
          <Image
            src="/images/comadreja/background.gif"
            alt="Hero Pattern"
            fill
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-3xl mx-auto text-center bg-white/80 backdrop-blur-sm p-8 rounded-lg shadow-lg">
          ...
          <div className="space-y-6 text-muted-foreground text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
            <AnimatedElement animation="fade-up" delay={300}>
              <p className="text-foreground font-medium text-xl sm:text-2xl">
                Jimi Mustela es una comadreja. Pero también es un narrador, un
                sobreviviente y un observador del mundo.
              </p>
            </AnimatedElement>

            <AnimatedElement animation="fade-up" delay={400}>
              <p>
                A través de su voz —irónica, sensible y a veces brutal— recorre
                episodios de su vida: la infancia, el amor, el arte, la ciudad,
                la soledad y el consumo.
              </p>
            </AnimatedElement>

            <AnimatedElement animation="fade-up" delay={500}>
              <p>
                Jimi habla desde un lugar ambiguo: entre la fábula, la
                autobiografía imaginaria y la crítica cultural.
              </p>
            </AnimatedElement>
            ...
            <AnimatedElement animation="fade-up" delay={600}>
              <div className="pt-8 border-t border-border mt-8">
                <p className="text-sm italic">
                  Jimi Mustela se inspira en los{" "}
            ...
            <AnimatedElement animation="fade-up" delay={700}>
              <p className="text-foreground font-medium pt-4">
                Su historia no pretende dar respuestas, sino abrir preguntas
                sobre cómo vivimos hoy.
              </p>
            </AnimatedElement>
          </div>
        </div>
