              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="aspect-video bg-muted border-2 border-border flex items-center justify-center">
                  <div className="relative w-full h-full">
                    <Image
                      src="/images/comadreja/teatro.gif"
                      alt="Teatro"
                      fill
            ...
            <div className="bg-background p-8 sm:p-10 border-2 border-foreground relative">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">
                    Esta es la autobiografía no autorizada (porque nadie la
                    pidió) de Jimi Mustela, una vieja gloria del espectáculo
                    barato que pasó de ser estrella de televisión a influencer
                    de popó… y de ahí al olvido más absoluto.
                  </p>
                  <p className="text-muted-foreground mb-6">
                    Entre carcajadas, sarcasmo y verdades incómodas, Jimi nos
                    cuenta cómo el sistema nos manipula, cómo nos dejamos
                    manipular y cómo, aun sabiendo todo esto, seguimos felices
                    de ser marionetas andantes.
                  </p>
                  <div className="flex flex-wrap items-center gap-4">
                    <span className="text-sm text-muted-foreground">
                      82 páginas • Ilustrado • Contiene códigos QR
                    </span>
                  </div>
